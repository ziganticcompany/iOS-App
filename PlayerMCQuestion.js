...
export default class PlayerMCQuestion extends React.Component {
  render() {
    return (   
        ...
        <View style={{flex:1}}>       
            ...
            <View style = {{
                width:SCREEN_WIDTH*(1/5), //Make variable that corresponds with the view before so widths add up to screen_width
                height: 6,
            ...
            <View style = {{alignItems: 'flex-start', marginHorizontal: 20, justifyContent: 'center', marginTop: 15}}>
              ...
              <Text style = {{fontSize: 20, color: 'rgb(50,50,50)', fontWeight: '500', marginTop: 15}}>
                Was level 3 too challenging or at a proper difficulty?
              </Text>
            ...
            <View style = {{flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 40,}}>
                <Button style = {{ padding: 10, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginLeft:25}} onPress={() => this.props.navigation.navigate('PlayerSurveyWarning')}>
                ...
                <Button style = {{ padding: 10, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginRight:25}} onPress={() => this.props.navigation.navigate('PlayerMCQuestion2')}>
