...
export default class PlayerMCQuestion5 extends React.Component {
  render() {
    return (   
        ...
        <View style={{flex:1}}>       
            ...
            <View style = {{
                width:SCREEN_WIDTH*(5/5), //Make variable that corresponds with the view before so widths add up to screen_width
                height: 6,
            ...
            <View style = {{flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 40,}}>
                ...
                <Button style = {{ padding: 10, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginLeft:25}} onPress={() => this.props.navigation.navigate('PlayerMCQuestion4')}>
                ...
                <Button style = {{ padding: 10, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginRight:25}} onPress={() => this.props.navigation.navigate('PlayerSurveySubmit')}>
